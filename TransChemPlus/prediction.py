...
model_path = "/home/devuser/cgy/GCN/GCN/models/best_gnn_model_finetune.pth"


csv_path = "/home/devuser/cgy/chemprop-Mob/data/Dielectric_Constant_Total.csv"


smiles_list, targets, _ = load_smiles_and_targets(
    csv_path,
    smiles_column="smiles",
    target_column="Dielectric_Constant_Total"
)
...
save_pred_csv = "/home/devuser/cgy/GCN/GCN/predictions.csv"

rows = []
for smi, y_true, y_pred in zip(smiles_list, ys, preds):
    rows.append({
        "smiles": smi,
        "y_true": float(y_true),
        "y_pred": float(y_pred)
